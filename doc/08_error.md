...
Error: Request failed with status code 404
    at handleResponse (xhr.ts:56)
    at XMLHttpRequest.handleLoad (xhr.ts:49)
client.js:91 [HMR] connected
app.ts:37 Timeout of 2000 ms exceeded
app.ts:27 Error: Request failed with status code 500
    at handleResponse (xhr.ts:56)
    at XMLHttpRequest.handleLoad (xhr.ts:49)
```
